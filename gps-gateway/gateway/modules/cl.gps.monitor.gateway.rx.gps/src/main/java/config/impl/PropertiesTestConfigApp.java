...
@Getter
@Setter
public class PropertiesTestConfigApp implements Configuration {

    private Properties properties;

    public static final UtilLogger log = UtilLogger.getLogger(PropertiesTestConfigApp.class);
    ...
    private void configureLogger() {
        ...
        PropertyConfigurator.configure(PropertiesConfigApp.class.getClassLoader().getResourceAsStream("log4j.properties"));
    }
    ...
    private void configureProperties() {
        ...
        UtilProperties.configure(PropertiesConfigApp.class.getClassLoader().getResourceAsStream("application.properties"));
